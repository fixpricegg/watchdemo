...
* Пользователь может зарегистрироваться, войти в аккаунт и получить доступ к ранее сохранённым результатам анализа.
...
~~~mermaid
gantt
    title WatchDemo — план разработки ИВР
    dateFormat  YYYY-MM-DD
    axisFormat  %d.%m

    section Прототип
    Парсер, статистика, радар            :done, p1, 2026-05-01, 2026-08-31
    Информация и геометрия карты         :done, p2, 2026-09-01, 2026-09-18

    section Заявка и архитектура
    Окончательная заявка                 :active, a1, 2026-09-18, 2026-09-22
    БД, авторизация, сохранение отчётов  :a2, 2026-09-19, 2026-09-30
    Второй показ кода                    :milestone, m1, 2026-10-01, 0d

    section MVP ИВР
    3–5 правил анализа                   :b1, 2026-09-19, 2026-10-18
    Единый пользовательский сценарий     :b2, 2026-10-02, 2026-10-18
    Пользовательское тестирование        :b3, 2026-10-19, 2026-11-04
    Продукт и отчёт                      :milestone, m2, 2026-11-05, 0d

    section Защита
    Финальная отладка и презентация      :c1, 2026-11-06, 2026-11-18
    Защита ИВР                           :milestone, m3, 2026-11-19, 2026-11-21
~~~
